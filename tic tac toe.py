...
def single_player():
    ...
    def checkForWin():
        ...
        button9['text'] == 'X'):
            ...
            tkinter.messagebox.showinfo("It is a Tie")
            tk.destroy()
...
def multi_player():
    ...
    def btnClick(buttons):
        ...
        if(TF()):
            ...
            #disableButton()
            tk.destroy()
            tkinter.messagebox.showinfo("Fill player name before starting")
            #normalButton()
...
def main():
    ...
    button_mp=Button
    f=Frame(root,height=75,width=1250,bg='black')
    #f.propagate(0)
    f.pack()
    ...
    #f.propagate(0)
    v.pack()
    q=Label(v,text='PLAY MULTIPLAYER',fg='red',height=3)
    q.pack()
    ...
    #f.propagate(0)
    m.pack()
    i=Label(m,text='PLAY SINGLEPLAYER',fg='red',height=3)
    i.pack()
    
    button2=Button(g,bg='blue', height=2, width=20,text='Multiplayer',fg='black',bd=3,command=multi_player)
    #button2.place(bordermode=INSIDE)
    button2.grid(row=3,column=1)
    
     
    button3=Button(k,bg='blue', height=2, width=20,text='single player',fg='black',bd=3,command=single_player)
    #button2.place(bordermode=INSIDE)
